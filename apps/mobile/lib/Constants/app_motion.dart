...
abstract final class AppMotion {
  ...
  /// Manual-advance recap slides; story_view pauses on show.
  static const recapStorySlide = Duration(hours: 24);
  static const recapIntro = Duration(milliseconds: 1800);
  static const recapIntroAutoAdvance = Duration(seconds: 3);
  static const recapCountUp = Duration(milliseconds: 1200);
  static const slide = Duration(milliseconds: 400);
  static const splashFluidStagger = Duration(milliseconds: 143);
  static const splashFluidPass = Duration(milliseconds: 210);
  static const splashFluidHoldFinal = Duration(milliseconds: 180);
  static const splashFluidBlackFade = Duration(milliseconds: 270);
  static const splashFluid = Duration(milliseconds: 1804);
  static const splashHold = Duration(milliseconds: 231);
