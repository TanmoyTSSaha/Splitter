...
- [x] 07-03: App Links + email auth callbacks — assetlinks.json, DeepLinkService, web deploy (Vercel deploy pending)
...
| 7. Google Auth (Closed Testing) | 3/3 | Complete (deploy pending) | 2026-08-08 |
