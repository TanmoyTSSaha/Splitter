...
class CurrencyService {
  ...
  Future<Map<String, double>> getRates(
    ...
    final cached = prefs.getString('${PrefKeys.fxRatesCache}_$base');

    final ts = prefs.getInt('${PrefKeys.fxRatesTimestamp}_$base') ?? 0;

    final age = DateTime.now().millisecondsSinceEpoch - ts;

    if (cached != null && age < CacheTtls.fxRatesMs) {
    ...
    try {
      ...
      final req = await client.getUrl(uri).timeout(AppMotion.fxRequestTimeout);
      ...
      await prefs.setString(
          '${PrefKeys.fxRatesCache}_$base', jsonEncode(rates));

      await prefs.setInt('${PrefKeys.fxRatesTimestamp}_$base',
